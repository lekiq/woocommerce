...
__webpack_require__.d(payment_settings_actions_namespaceObject, {
  getPaymentGatewaySuggestionsError: () => (getPaymentGatewaySuggestionsError),
  getPaymentGatewaySuggestionsRequest: () => (getPaymentGatewaySuggestionsRequest),
  getPaymentGatewaySuggestionsSuccess: () => (getPaymentGatewaySuggestionsSuccess),
...
__webpack_require__.d(payment_settings_resolvers_namespaceObject, {
  ...
  getRegisteredPaymentGateways: () => (getRegisteredPaymentGateways)
});
...
__webpack_require__.d(payment_settings_selectors_namespaceObject, {
  ...
  getOtherExtensionSuggestions: () => (getOtherExtensionSuggestions),
  getPreferredExtensionSuggestions: () => (getPreferredExtensionSuggestions),
  getRegisteredPaymentGateways: () => (selectors_getRegisteredPaymentGateways),
...
var payment_settings_action_types_ACTION_TYPES = /*#__PURE__*/function (ACTION_TYPES) {
  ACTION_TYPES["GET_PAYMENT_GATEWAY_SUGGESTIONS_REQUEST"] = "GET_PAYMENT_GATEWAY_SUGGESTIONS_REQUEST";
  ACTION_TYPES["GET_PAYMENT_GATEWAY_SUGGESTIONS_SUCCESS"] = "GET_PAYMENT_GATEWAY_SUGGESTIONS_SUCCESS";
  ACTION_TYPES["GET_PAYMENT_GATEWAY_SUGGESTIONS_ERROR"] = "GET_PAYMENT_GATEWAY_SUGGESTIONS_ERROR";
...
function getPaymentGatewaySuggestionsRequest() {
  return {
    type: payment_settings_action_types_ACTION_TYPES.GET_PAYMENT_GATEWAY_SUGGESTIONS_REQUEST
  };
}
function getPaymentGatewaySuggestionsSuccess(registeredPaymentGateways, offlinePaymentGateways, preferredExtensionSuggestions, otherExtensionSuggestions, suggestionCategories) {
  ...
  return {
    type: payment_settings_action_types_ACTION_TYPES.GET_PAYMENT_GATEWAY_SUGGESTIONS_SUCCESS,
    registeredPaymentGateways: registeredPaymentGateways,
    offlinePaymentGateways: sortedOfflinePaymentGateways,
    preferredExtensionSuggestions: preferredExtensionSuggestions,
    otherExtensionSuggestions: otherExtensionSuggestions,
    suggestionCategories: suggestionCategories
  };
}
function getPaymentGatewaySuggestionsError(error) {
  return {
    type: payment_settings_action_types_ACTION_TYPES.GET_PAYMENT_GATEWAY_SUGGESTIONS_ERROR,
    error: error
  };
}
...
var payment_settings_resolvers_marked = /*#__PURE__*/regenerator_default().mark(getRegisteredPaymentGateways),
...
function getRegisteredPaymentGateways() {
  var paymentSuggestionsResponse;
  return regenerator_default().wrap(function getRegisteredPaymentGateways$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        _context.next = 2;
        return getPaymentGatewaySuggestionsRequest();
      case 2:
        _context.prev = 2;
        _context.next = 5;
        return (0,data_controls_build_module/* apiFetch */.nr)({
      ...
      case 5:
        paymentSuggestionsResponse = _context.sent;
        _context.next = 8;
        return getPaymentGatewaySuggestionsSuccess(paymentSuggestionsResponse.gateways, paymentSuggestionsResponse.offline_payment_methods, paymentSuggestionsResponse.preferred_suggestions, paymentSuggestionsResponse.other_suggestions, paymentSuggestionsResponse.suggestion_categories);
      case 8:
        _context.next = 14;
        break;
      case 10:
        ...
        _context.t0 = _context["catch"](2);
        _context.next = 14;
        return getPaymentGatewaySuggestionsError(_context.t0);
      case 14:
      case "end":
        return _context.stop();
    }
...
function getOfflinePaymentGateways() {
  return regenerator_default().wrap(function getOfflinePaymentGateways$(_context2) {
    while (1) switch (_context2.prev = _context2.next) {
      case 0:
        _context2.next = 2;
        return getRegisteredPaymentGateways();
      case 2:
      case "end":
        return _context2.stop();
    }
...
function selectors_getRegisteredPaymentGateways(state) {
...
function getPreferredExtensionSuggestions(state) {
  return state.preferredExtensionSuggestions;
}
function getOtherExtensionSuggestions(state) {
...
var payment_settings_reducer_reducer = function reducer() {
  ...
  if (payload && 'type' in payload) {
    switch (payload.type) {
      case payment_settings_action_types_ACTION_TYPES.GET_PAYMENT_GATEWAY_SUGGESTIONS_REQUEST:
        return payment_settings_reducer_objectSpread(payment_settings_reducer_objectSpread({}, state), {}, {
          isFetching: true
        });
      case payment_settings_action_types_ACTION_TYPES.GET_PAYMENT_GATEWAY_SUGGESTIONS_SUCCESS:
        return payment_settings_reducer_objectSpread(payment_settings_reducer_objectSpread({}, state), {}, {
          isFetching: false,
          registeredPaymentGateways: payload.registeredPaymentGateways,
          offlinePaymentGateways: payload.offlinePaymentGateways,
          preferredExtensionSuggestions: payload.preferredExtensionSuggestions,
          otherExtensionSuggestions: payload.otherExtensionSuggestions,
          suggestionCategories: payload.suggestionCategories
        });
      case payment_settings_action_types_ACTION_TYPES.GET_PAYMENT_GATEWAY_SUGGESTIONS_ERROR:
        return payment_settings_reducer_objectSpread(payment_settings_reducer_objectSpread({}, state), {}, {
          isFetching: false,
