...
class WC_Settings_Emails extends WC_Settings_Page {
	...
	protected function get_settings_for_default_section() {
		...
		$base_color_setting_in_template_opts        = $base_color_setting;
		$bg_color_setting_in_template_opts          = $bg_color_setting;
		$body_bg_color_setting_in_template_opts     = $body_bg_color_setting;
		$body_text_color_setting_in_template_opts   = $body_text_color_setting;
		$footer_text_color_setting_in_template_opts = $footer_text_color_setting;

		$base_color_setting_in_palette        = null;
		$bg_color_setting_in_palette          = null;
		$body_bg_color_setting_in_palette     = null;
		$body_text_color_setting_in_palette   = null;
		$footer_text_color_setting_in_palette = null;

		if ( FeaturesUtil::feature_is_enabled( 'email_improvements' ) ) {
			$base_color_setting_in_template_opts        = null;
			$bg_color_setting_in_template_opts          = null;
			$body_bg_color_setting_in_template_opts     = null;
			$body_text_color_setting_in_template_opts   = null;
			$footer_text_color_setting_in_template_opts = null;

			$base_color_setting_in_palette        = $base_color_setting;
			$bg_color_setting_in_palette          = $bg_color_setting;
			$body_bg_color_setting_in_palette     = $body_bg_color_setting;
			$body_text_color_setting_in_palette   = $body_text_color_setting;
			$footer_text_color_setting_in_palette = $footer_text_color_setting;
		}
